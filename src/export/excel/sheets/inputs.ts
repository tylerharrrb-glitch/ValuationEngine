...
import type { BalanceSheet, CashFlowStatement, IncomeStatement } from '../../../domain/company';
...
type Line<T> = [keyof T & string, string];
...
type DriverSpec = [keyof YearDrivers, string, string, Fmt, boolean];
